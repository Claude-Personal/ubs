...
UBS_MSG_en_MENU_VERSION_PROMPT="Which version do you want to bump?"
UBS_MSG_ja_MENU_VERSION_PROMPT="どのバージョンを上げますか?"
UBS_MSG_zh_MENU_VERSION_PROMPT="要升级哪个版本?"

UBS_MSG_ko_MENU_OPT_PATCH_BUMP="1) Patch 버전 올리기"
UBS_MSG_en_MENU_OPT_PATCH_BUMP="1) Bump patch version"
UBS_MSG_ja_MENU_OPT_PATCH_BUMP="1) パッチバージョンを上げる"
UBS_MSG_zh_MENU_OPT_PATCH_BUMP="1) 升级补丁版本"

UBS_MSG_ko_MENU_OPT_MINOR_BUMP="2) Minor 버전 올리기"
UBS_MSG_en_MENU_OPT_MINOR_BUMP="2) Bump minor version"
UBS_MSG_ja_MENU_OPT_MINOR_BUMP="2) マイナーバージョンを上げる"
UBS_MSG_zh_MENU_OPT_MINOR_BUMP="2) 升级次要版本"

UBS_MSG_ko_MENU_OPT_MAJOR_BUMP="3) Major 버전 올리기"
UBS_MSG_en_MENU_OPT_MAJOR_BUMP="3) Bump major version"
UBS_MSG_ja_MENU_OPT_MAJOR_BUMP="3) メジャーバージョンを上げる"
UBS_MSG_zh_MENU_OPT_MAJOR_BUMP="3) 升级主要版本"
...
UBS_MSG_ja_VERSION_UPDATED="バージョン更新: %s → %s"
...
UBS_MSG_en_UPDATE_OPENSSL_REQUIRED="openssl is required to verify the manifest signature."
UBS_MSG_ja_UPDATE_OPENSSL_REQUIRED="manifestの署名検証にはopensslが必要です。"
UBS_MSG_zh_UPDATE_OPENSSL_REQUIRED="验证 manifest 签名需要 openssl。"
...
UBS_MSG_ja_UPDATE_SIGNATURE_INVALID="manifestの署名検証に失敗しました — ダウンロードチャネルが侵害されている可能性があります。"
UBS_MSG_zh_UPDATE_SIGNATURE_INVALID="manifest 签名验证失败——下载渠道可能已被入侵。"
...
UBS_MSG_ja_UPDATE_SHA256_MISMATCH="SHA-256が一致しません: %s"
